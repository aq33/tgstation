/turf/open/floor/plating/smooth
	...
	icon = 'icons/obj/xenoarch/_smooth.dmi'
	icon_state = "grass"
	...
	var/smooth_icon = 'icons/obj/xenoarch/grass.dmi'
...
/turf/open/floor/plating/smooth/grass
	...
	heavyfootstep = FOOTSTEP_GENERIC_HEAVY
	layer = 2.1
	smooth_icon = 'icons/obj/xenoarch/grass.dmi'
...
/turf/open/floor/plating/smooth/dirt
	...
	heavyfootstep = FOOTSTEP_GENERIC_HEAVY
	layer = 2.09
	smooth_icon = 'icons/obj/xenoarch/dirt.dmi'
...
/turf/open/water/lavaland_jungle
	baseturfs = /turf/open/lava/smooth/lava_land_surface
	icon = 'icons/obj/xenoarch/water.dmi'
	icon_state = "shallow"
	color = "#648363"
	slowdown = 3
