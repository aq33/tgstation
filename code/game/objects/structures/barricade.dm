...
/obj/structure/peacekeeper_barricade/metal/attackby(obj/item/I, mob/user, params)
	...
	if(istype(I, /obj/item/stack/barbed_wire))
		...
		if(!closed)
			wired_overlay = image('icons/obj/barricades.dmi', icon_state = "[barricade_type]_wire")
		else
			wired_overlay = image('icons/obj/barricades.dmi', icon_state = "[barricade_type]_closed_wire")
...
/obj/structure/peacekeeper_barricade/proc/update_overlay()
	...
	overlays -= wired_overlay
	if(!closed)
		wired_overlay = image('icons/obj/barricades.dmi', icon_state = "[src.barricade_type]_wire")
	else
		wired_overlay = image('icons/obj/barricades.dmi', icon_state = "[src.barricade_type]_closed_wire")
	overlays += wired_overlay
