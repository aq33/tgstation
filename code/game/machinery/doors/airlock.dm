...
/obj/machinery/door/airlock/try_to_crowbar(obj/item/I, mob/living/user)
	...
	if(istype(I, /obj/item/crowbar/power)||(istype(I, /obj/item/mecha_parts/mecha_equipment/hydraulic_clamp)&&(!istype(I, /obj/item/mecha_parts/mecha_equipment/hydraulic_clamp/makeshift))))
		if(isElectrified())
...
/obj/machinery/door/airlock/open(forced=0)
	...
	if(forced < 2)
		...
		playsound(src, 'sound/machines/airlock/open_force.ogg', 30, TRUE)

	if(autoclose)
		autoclose_in(normalspeed ? 100 : 15)
...
/obj/machinery/door/airlock/close(forced=0)
	...
	if(forced < 2)
		...
		playsound(src, 'sound/machines/airlock/close_force.ogg', 30, TRUE)
