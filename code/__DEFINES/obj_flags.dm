...
#define NO_PICKUP				(1<<12) //! can this item be picked up? used for items that are "part" of other items
...
#define NOSLIP_SMALL            (1<<5)  //! prevents from slipping on floors that don't slip when walking when running - water, blood
