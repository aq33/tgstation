...
TOGGLE_CHECKBOX(/datum/verbs/menu/Settings/Sound, toggle_radio_sound)()
	...
	to_chat(usr, "You will now [(usr.client.prefs.toggles & SOUND_RADIO) ? "hear radio sounds" : "no longer hear radio noise"].")
	usr.client.prefs.save_preferences()
	SSblackbox.record_feedback("nested tally", "preferences_verb", 1, list("Toggle Radio Sound", "[usr.client.prefs.toggles & SOUND_RADIO ? "Enabled" : "Disabled"]")) //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
