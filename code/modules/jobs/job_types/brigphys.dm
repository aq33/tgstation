/datum/job/brig_phys
	...
	access = list(ACCESS_WEAPONS, ACCESS_MECH_SECURITY, ACCESS_BRIG, ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_COURT, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE, ACCESS_MEDICAL, ACCESS_BRIGPHYS) //AQ EDIT
	minimal_access = list(ACCESS_WEAPONS, ACCESS_MECH_SECURITY, ACCESS_BRIG, ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_COURT, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE, ACCESS_MEDICAL, ACCESS_BRIGPHYS) //AQ EDIT
