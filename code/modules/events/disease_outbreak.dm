...
/datum/round_event/disease_outbreak/announce(fake)
	priority_announce("Potwierdzono wystąpienie wirusowego zagrożenia biologicznego siódmego poziomu na pokładzie [station_name()]. Cały personel ma za zadanie powstrzymać rozprzestrzenienie.", "Alarm biologiczny", 'sound/ai/outbreak7.ogg')
