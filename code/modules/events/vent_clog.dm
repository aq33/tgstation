...
/datum/round_event/vent_clog/announce()
	priority_announce("Sieć absorberów doświadcza właśnie przypływu ciśnienia zwrotnego. Spodziewane jest uwolnienie się części zawartości.", "Ostrzeżenie atmosferyczne")
...
/datum/round_event/vent_clog/beer/announce()
	priority_announce("Sieć absorberów doświadcza właśnie niespodziewanego przypływu piwa pod ciśnieniem. Spodziewane jest uwolnienie się części zawartości.", "Ostrzeżenie atmosferyczne")
...
/datum/round_event/vent_clog/plasma_decon/announce()
	priority_announce("Na stacji rozpylane są właśnie eksperymentalne środki odkażania plazmy. Prosimy trzymać się zdala od krat wenylacyjnych i nie wdychać wydobywającego się dymu.", "Ostrzeżenie od Centralnego Dowództwa")
