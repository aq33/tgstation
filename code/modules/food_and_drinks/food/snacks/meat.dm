...
/obj/item/reagent_containers/food/snacks/meat/slab/hamster/Initialize()
	. = ..()
	AddElement(/datum/element/swabable, CELL_LINE_TABLE_PUG, CELL_VIRUS_TABLE_GENERIC_MOB)
...
/obj/item/reagent_containers/food/snacks/meat/crab
	...
	bonus_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/nutriment/vitamin = 2, /datum/reagent/consumable/cooking_oil = 2, /datum/reagent/consumable/nutriment/protein = 2)
