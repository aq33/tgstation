...
/obj/structure/blob/proc/chemeffectreport(mob/user)
	...
	. = list()
	if(overmind)
		. += {"<b>Rodzaj Grzyba:: <font color=\"[overmind.blobstrain.color]\">[overmind.blobstrain.name]</font><span class='notice'>.</span></b>\n
				<b>Efekt:</b> <span class='notice'>[overmind.blobstrain.analyzerdescdamage]</span>\n
				<b>Właściwości:</b> <span class='notice'>[overmind.blobstrain.analyzerdesceffect]</span>"}
	else
