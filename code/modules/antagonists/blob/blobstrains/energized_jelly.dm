...
/datum/blobstrain/reagent/energized_jelly
	...
	description = "powoduje lekkie zmęczenie oraz wysokie obrażenia od niedotlenienia. Dodatkowo powoduje, że osoby zaatakowane na krótką chwilę tracą możliwość oddychania."
	effectdesc = "dodatkowo przewodzi prąd elektryczny oraz otrzymuje obrażenia od impulsów EMP."
