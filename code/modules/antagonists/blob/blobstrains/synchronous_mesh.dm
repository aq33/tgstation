...
/datum/blobstrain/reagent/synchronous_mesh
	...
	effectdesc = "Dodatkowo zaatakowany blob rozłoży obrażenia na wszystkie bloby stykające się z zaatakowanym blobem."
	analyzerdescdamage = "Zadaje obrażenia fizyczne, skalujące się z każdym blobem wokół ofiary."
	analyzerdesceffect = "Zaatakowany blob rozłoży obrażenia na wszystkie bloby stykające się z zaatakowanym blobem."
	color = "#65ADA2"
