...
/datum/antagonist/traitor/on_gain()
	...
	finalize_traitor()
	RegisterSignal(owner.current, COMSIG_MOVABLE_HEAR, .proc/handle_hearing) //Aquila Edit
	..()
...
/datum/antagonist/traitor/on_removal()
	...
	UnregisterSignal(owner.current, COMSIG_MOVABLE_HEAR, .proc/handle_hearing) //Aquila Edit
	SSticker.mode.traitors -= owner
