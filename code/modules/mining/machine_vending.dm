...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Kinetic Accelerator Rifle",	/obj/item/gun/energy/kinetic_accelerator,							750),
		new /datum/data/mining_equipment("Kinetic Accelerator Pistol",	/obj/item/gun/energy/kinetic_accelerator/pistol,					750),
