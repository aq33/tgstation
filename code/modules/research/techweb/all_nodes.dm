...
/datum/techweb_node/nanite_smart
	...
	design_ids = list("purging_nanites", "metabolic_nanites", "stealth_nanites", "memleak_nanites","sensor_voice_nanites", "sensor_impact_nanites", "voice_nanites", "cloud_change_nanites")
