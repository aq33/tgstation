...
/datum/nanite_program/protocol/kickstart/active_effect()
	nanites.adjust_nanites(null, 4.5)
...
/datum/nanite_program/protocol/factory
	...
	var/max_efficiency = 500 //Goes up to 2 bonus regen per tick after 8 minutes and 20 seconds
...
/datum/nanite_program/protocol/factory/on_emp(severity)
	..()
	factory_efficiency = max(0, factory_efficiency - 150)
