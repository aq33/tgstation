...
/datum/martial_art/ostrycienmgly
	name = "ostrycienmgly"
	id = MARTIALART_OSTRYCIENMGLY
	help_verb = /mob/living/carbon/human/proc/ostrycienmgly_help       //here is the verb for reminding yourself the combos




/datum/martial_art/ostrycienmgly/proc/check_streak(mob/living/carbon/human/A, mob/living/carbon/human/D)
...
/datum/martial_art/ostrycienmgly/proc/Subdue(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!can_use(A))
		return FALSE
	if(D.mobility_flags & MOBILITY_STAND)
		...
		log_combat(A, D, "subdued (ostrycienmgly)")

/datum/martial_art/ostrycienmgly/grab_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!can_use(A))
		return FALSE
	if(A==D)
...
/datum/martial_art/ostrycienmgly/harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	add_to_streak("H",D)
	if(check_streak(A,D))
		return 1
	basic_hit(A,D)
...
/datum/martial_art/ostrycienmgly/disarm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	add_to_streak("D",D)
	if(check_streak(A,D))
		return 1
	basic_hit(A,D)
...
/mob/living/carbon/human/proc/ostrycienmgly_help()
