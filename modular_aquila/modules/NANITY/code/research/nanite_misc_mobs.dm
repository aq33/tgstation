/mob/living/simple_animal/hostile/nanophage
	...
	icon_dead = "nanophage"
	icon = 'modular_aquila/modules/NANITY/icons/nanophage.dmi'
	gender = NEUTER
	speak_emote = list("states")
	turns_per_move = 0
	melee_damage = 1
	attacktext = "bites"
	attack_sound = 'modular_aquila/modules/NANITY/sound/nanobuzz.ogg'
	response_help  = "shoos"
	...
	ventcrawler = VENTCRAWLER_ALWAYS
	deathsound = 'modular_aquila/modules/NANITY/sound/nanodead.ogg'
